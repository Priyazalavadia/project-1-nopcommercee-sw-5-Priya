...
public class ElectronicsPage extends Utility{
    ...
    public void electronicsPage() {
        CustomListeners.test.log(Status.PASS,"mouse hoover on Electronics");

        mouseHoverToElement(mouseHooverOnElectronics);
    }
    public void setMouseHooverOnCellPhone() {
        CustomListeners.test.log(Status.PASS,"mouse hover on cellphone");

        mouseHoverToElementAndClick(cellphone);
    }
    public String cellPhone() {
        CustomListeners.test.log(Status.PASS,"cellphone");
    ...
    public void changeQuntity1() {
        CustomListeners.test.log(Status.PASS,"Change Quntity");
    ...
    public void closeButton() {
        CustomListeners.test.log(Status.PASS,"close Button");
    ...
    public String totalText698 () {
        CustomListeners.test.log(Status.PASS,"Verify Amount");
    ...
    public void enterFirstname(String text) {
        CustomListeners.test.log(Status.PASS,"Firstname" + text);
        sendTextToElement(firstName, text);
    }

    public void enterLastname(String text) {
        CustomListeners.test.log(Status.PASS,"Lastname"+ text);
    ...
    public void enterConfirmPassword(String text){
        CustomListeners.test.log(Status.PASS,"Confirm Password"+ text);
    ...
    public void selectCreditCard(String text){
        CustomListeners.test.log(Status.PASS,"Enter Card Details"+ text);
    ...
    public void clickOnConfirm(){
        CustomListeners.test.log(Status.PASS,"Click To Confirm");
